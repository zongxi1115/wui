...
export const PropDescriptions: Record<string, Record<string, string>> = {
  ...
  "multi-select": {
    options: "可供选择的选项集合。",
    value: "受控模式下当前选中的值数组。",
    defaultValue: "非受控模式下初始选中的值数组。",
    onValueChange: "选中值变化或清空时触发。",
    placeholder: "未选择任何选项时显示的占位文本。",
    searchPlaceholder: "下拉搜索输入框的占位文本。",
    emptyText: "没有匹配选项时显示的内容。",
    maxDisplay: "触发器内最多直接展示的已选项数量。",
    clearable: "是否显示一键清空按钮。",
    size: "组件的尺寸密度。",
    contentClassName: "应用于浮层的额外类名。",
    ...common,
  },
  cascader: {
    options: "级联选项树。",
