...
export default function DescriptionsDemo() {
  return (
    ...
    >
      <DescriptionsItem label="项目名称">移动端体验升级</DescriptionsItem>
      ...
      <DescriptionsItem label="计划上线">2026-09-30</DescriptionsItem>
      <DescriptionsItem label="优先级">P1</DescriptionsItem>
      <DescriptionsItem label="项目说明">
        统一关键流程的视觉反馈、触控手感与无障碍体验，降低复杂页面的认知负担。
      </DescriptionsItem>
    </Descriptions>
  )
}
