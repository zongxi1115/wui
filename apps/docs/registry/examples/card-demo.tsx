  ...
  return (
    <Card className="w-full max-w-md">
      <CardHeader>
        ...
        <CardDescription>统一关键业务流程的视觉反馈与交互微动效。</CardDescription>
        <CardAction>
          <Button variant="ghost" size="icon" aria-label="查看项目详情">
      ...
      <CardContent className="flex flex-col gap-5">
        <div className="flex flex-col gap-2.5">
          <div className="flex items-baseline justify-between">
            <span className="text-muted-foreground text-xs">整体完成进度</span>
