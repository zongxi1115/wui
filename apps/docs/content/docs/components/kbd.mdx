...
<PropsTable
  data={[
    ...
    },
    {
      ...
      type: "boolean",
      default: "false",
      description: "以主色高亮并轻微下沉，表示该键正被按下。适合在新手引导、快捷键设置中实时映射用户的键盘输入；系统开启“减少动态效果”时仅变色不位移。",
    },
    {
      prop: "className",
      type: "string",
...
在输入框中按下 <kbd>Enter</kbd> 或 <kbd>Shift</kbd> + <kbd>Enter</kbd>，对应的按键提示会实时高亮并轻微下沉，帮助用户建立快捷键记忆：

<ComponentPreview name="kbd-live" />
